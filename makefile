proFile: src/recruitEmployee.o src/printAll.o src/printOne.o src/lookOnId.o src/lookOnFullName.o src/sortEmployeesId.o src/loadEmpData.o src/countEmployees.o src/fireAll.o src/fireOne.o
	gcc -std=c99 -Wall src/recruitEmployee.o src/printAll.o src/printOne.o src/lookOnId.o src/lookOnFullName.o src/sortEmployeesId.o src/loadEmpData.o src/countEmployees.o src/fireAll.o src/fireOne.o -o bin/proFile
